...
steps.forEach((step) => {
  ...
  const prevBtn = step.querySelector('.perv-stp');
  if (prevBtn) {
...
function switchPrice(checked) {
  ...
  if (checked) {
    ...
    document.querySelector('.freeMonths1').style.display = 'block';
    document.querySelector('.freeMonths2').style.display = 'block';
    document.querySelector('.freeMonths3').style.display = 'block';
    setTime(true);
  } else {
    prices[0].innerHTML = `$${monthlyPrice[0]}/mo`;
    prices[1].innerHTML = `$${monthlyPrice[1]}/mo`;
    prices[2].innerHTML = `$${monthlyPrice[2]}/mo`;
    document.querySelector('.freeMonths1').style.display = 'none';
    document.querySelector('.freeMonths2').style.display = 'none';
    document.querySelector('.freeMonths3').style.display = 'none';
    setTime(false);
  }
}
